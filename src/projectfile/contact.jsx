...
function GetInTouch() {
  return (
    ...
    <h1  className='text-center pt-20 pb-20 text-5xl border-ms-0 me-0'>Get In Touch</h1>
     <div className="bg-white m-0 p-0 pos w-full">
      <div className="border-4 border-t-0 border-blue-400 ">
        <div className="md:flex">
            <div className="md:w-[30%] sm:px-6 px-2">
              <iframe
                title="Google Maps"
                className="w-full "
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3739.9923834312067!2d78.11508857469755!3d20.383203909638887!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd3e8a4396e91cb%3A0xda96015d78fff47f!2sSusanskar%20Vidya%20Mandir!5e0!3m2!1sen!2sin!4v1707890749357!5m2!1sen!2sin4"
        ...
        <div className=" md:w-[70%] md:border-l-4 border-blue-400 text-center mb-5 ">
